...
LEVEL_10_IMAGE_WIDTH_RATIO, LEVEL_10_IMAGE_HEIGHT_RATIO = 1074 * 2 / 3 / 800, 379 * 2 / 3 / 600

# Calculate actual dimensions based on screen size
LEVEL_1_IMAGE_WIDTH, LEVEL_1_IMAGE_HEIGHT = int(LEVEL_1_IMAGE_WIDTH_RATIO * WIDTH), int(LEVEL_1_IMAGE_HEIGHT_RATIO * HEIGHT)
LEVEL_3_IMAGE_WIDTH, LEVEL_3_IMAGE_HEIGHT = int(LEVEL_3_IMAGE_WIDTH_RATIO * WIDTH), int(LEVEL_3_IMAGE_HEIGHT_RATIO * HEIGHT)
LEVEL_5_IMAGE_WIDTH, LEVEL_5_IMAGE_HEIGHT = int(LEVEL_5_IMAGE_WIDTH_RATIO * WIDTH), int(LEVEL_5_IMAGE_HEIGHT_RATIO * HEIGHT)
LEVEL_7_IMAGE_WIDTH, LEVEL_7_IMAGE_HEIGHT = int(LEVEL_7_IMAGE_WIDTH_RATIO * WIDTH), int(LEVEL_7_IMAGE_HEIGHT_RATIO * HEIGHT)
LEVEL_10_IMAGE_WIDTH, LEVEL_10_IMAGE_HEIGHT = int(LEVEL_10_IMAGE_WIDTH_RATIO * WIDTH), int(LEVEL_10_IMAGE_HEIGHT_RATIO * HEIGHT)
